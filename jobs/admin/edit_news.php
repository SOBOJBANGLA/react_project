      ...
      <div class="page-content">
        ...
        <?php
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $sq = "UPDATE news SET date='$date', title='$title',details='$details',link='$link' WHERE id='$id'";
                            ...
                            $sql = $conn->query("SELECT * FROM news WHERE id='$id'");
                                $row = $sql->fetch_assoc();
        ...
        <h6 class="mb-0 text-uppercase">Edit News information</h6>
                  <hr>
                  <form class="row g-3" method="post" >
                    ...
                    <div class="col-12">
                    <label>Details</label>
                    <textarea name="details" class="form-control" placeholder="Enter Details"  required><?php echo $row['details'] ?></textarea>
                    </div>
                    <div class="col-12">
                      <label class="form-label">News links</label>
                      <input type="text" name="link" class="form-control" placeholder="Enter News links" value="<?php echo $row['link'] ?>" required>
                    </div>
