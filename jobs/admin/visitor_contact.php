          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0 align-items-center">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="padding: 10px;">Visitor Contact information</li>
              </ol>
            </nav>
          </div>
...
<div class="container-fluid">
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center ">
                            <div class="col-md-8">
                                <div class="page-title-box">
                                    <h4 class="page-title">Visitor Contact List</h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <?php while($data = mysqli_fetch_assoc($query)){ ?>
                                            ...
                                            <td><?php echo $data['massage'] ?></td>
                                                ...
                                                <a onclick="return confirm('Are you sure to delete?')" href='delete_contact.php?id=<?php echo $data['id'] ?>'><input class="btn btn-danger" type="reset" value="Delete"></a>
                                                </div>
                                            </td>
